            ...
            if (lista != undefined && lista.length > 0) {
                if (lista['Erro'] != undefined) {
                    ...
                    var row = '<tr value="' + lista[0].CODIGO_USUARIO + '">' +
                               ...
                               '<td class="centeralign"><a title="Excluir" href="#modalCadastrar" onclick="javascript:LimparCadastrar();FuncaoTelaModal(\'Alterar\', ' + usuarios[0].CODIGO_USUARIO + ');CarregarUsuario(' + usuarios[0].CODIGO_USUARIO + ');" data-toggle="modal"><i class="iconfa-pencil"></i></a></td>' +
