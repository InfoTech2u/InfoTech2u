...
{
    public partial class ManterContribuicaoSindical : System.Web.UI.Page
    {
        ...
        {
            lblErrorData.Style.Add("display", "none");
        ...
        protected void CarregarIncludes()
        {
            ...
            InfoTech2uControlHtmlUtil.IncludeHtmlGenericControl(this.Page, "js", pachJs, "ManterContribuicaoSindical.js");
        }
    }
}