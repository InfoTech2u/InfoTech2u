...
namespace InfoTech2u.Verithus.VO
{
    ...
    public partial class TipoBeneficioVO
    {
        public TipoBeneficioVO()
        {
            this.DependenteVO = new HashSet<DependenteVO>();
        }
    
        public int CodigoTipoBeneficio { get; set; }
        public Nullable<int> CodigoCategoriaBeneficio { get; set; }
        ...
        public virtual CategoriaBeneficioVO CategoriaBeneficioVO { get; set; }
    }
}
