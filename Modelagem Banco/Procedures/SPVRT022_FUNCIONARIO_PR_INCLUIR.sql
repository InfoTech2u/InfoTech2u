...
/****** Object:  StoredProcedure [dbo].[SPVRT022_FUNCIONARIO_PR_INCLUIR]    Script Date: 28/09/2014 03:40:55 ******/
...
BEGIN
	BEGIN TRY
		BEGIN TRANSACTION
			...
			IF(@@ERROR = 0)
				BEGIN
				SET @DESC = 'SUCESSO AO INCLUIR UM FUNCIONÁRIO - CODIGO DO FUNCIONÁRIO' + CAST(@CODIGO_FUNCIONARIO AS VARCHAR)

				EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'A', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE FUNCIONÁRIO';
				--Retorna da inclusão
				SELECT
	...
	BEGIN CATCH
		...
		SET @DESC = 'ERRO AO INCLUIR UM TIPO DE TAREFA - CODIGO DO ERRO' + CAST(@@ERROR AS VARCHAR)
			...
			EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE TIPO DE TAREFA';
		...
		SET @DESC = 'ERRO AO INCLUIR UM FUNCIONÁRIO - CODIGO DO ERRO' + CAST(@ERROR_NUMBER AS VARCHAR)

		EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE FUNCIONÁRIO';
