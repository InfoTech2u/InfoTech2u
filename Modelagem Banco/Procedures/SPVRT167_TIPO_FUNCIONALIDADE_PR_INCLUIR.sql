...
BEGIN
	...
	IF(@@ERROR <>0)
		BEGIN
			...
			EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE TIPO DE FUNCIONALIDADE';
	...
	ELSE
		BEGIN
			...
			SET @DESC = 'SUCESSO AO INCLUIR UM TIPO DE FUNCIONALIDADE - CODIGO DO TIPO DE FUNCIONALIDADE' + CAST(@@IDENTITY AS VARCHAR)

			EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'A', '' , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE TIPO DE FUNCIONALIDADE';
