...
AS
	...
	ELSE
		BEGIN
			...
			SET @DESC = 'SUCESSO AO INCLUIR UM TIPO DE TAREFA - CODIGO DO TIPO DE TAREFA' + CAST(@@IDENTITY AS VARCHAR)

			EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'A', '' , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE TIPO DE TAREFA';
