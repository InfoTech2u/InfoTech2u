...
BEGIN
	...
	IF(@@ERROR <>0)
		BEGIN
			...
			EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE TIPO DE FORMA DE PAGAMENTO';
	...
	ELSE
		BEGIN
			...
			SET @DESC = 'SUCESSO AO INCLUIR UM TIPO DE FORMA DE PAGAMENTO - CODIGO DO TIPO DE FORMA DE PAGAMENTO' + CAST(@@IDENTITY AS VARCHAR)

			EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'A', '' , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE TIPO DE FORMA DE PAGAMENTO';
