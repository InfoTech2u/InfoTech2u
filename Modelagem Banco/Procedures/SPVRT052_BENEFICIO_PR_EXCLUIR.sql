...
/****** Object:  StoredProcedure [dbo].[SPVRT052_BENEFICIO_PR_EXCLUIR]    Script Date: 03/10/2014 06:17:56 ******/
DROP PROCEDURE [dbo].[SPVRT052_BENEFICIO_PR_EXCLUIR]
GO
...
CREATE PROCEDURE [dbo].[SPVRT052_BENEFICIO_PR_EXCLUIR]
(
		...
		BEGIN
			...
			BEGIN
				...
				SET @DESC = 'SUCESSO AO EXCLUIR UM BENEFÍCIO - CODIGO DO BENEFÍCIO' + CAST(@CODIGO_DEPENDENTE AS VARCHAR)
					EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'A', '' , @CODIGO_USUARIO_ALTERACAO, 'EXCLUSÃO DE BENEFÍCIO';
				...
				BEGIN
					...
					EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_ALTERACAO, 'EXCLUSÃO DE BENEFÍCIO';
				END
				RETURN;
			END
			ELSE
