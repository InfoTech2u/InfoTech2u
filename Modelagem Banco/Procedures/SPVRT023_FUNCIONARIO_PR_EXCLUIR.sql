...
BEGIN
	...
	IF(@@ERROR <>0)
		BEGIN
			...
			EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_ALTERACAO, 'EXCLUSÃO DE FUNCIONÁRIO';
	...
	ELSE
		BEGIN
			...
			EXEC dbo.SPVRT168_LOG_PR_INCLUIR 'A', @DESC , @CODIGO_USUARIO_ALTERACAO, 'EXCLUSÃO DE FUNCIONÁRIO';
			RETURN
		END
