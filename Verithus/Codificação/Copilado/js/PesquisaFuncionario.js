jQuery(document).ready(function () {
    ...
    jQuery("#btnAlteracaoCargoSalario").click(function () {
        ...
        if (codigoSel != null)
            jQuery(window.document.location).attr('href', 'ManterAlteracaoCargoSalarioFuncionario.aspx?idUser=' + codigoSel);
        else {
            jQuery.alerts.dialogClass = 'alert-warning';
            jAlert('Selecione um funcionario', 'Alerta', function () {
                jQuery.alerts.dialogClass = null; // reset to default
    ...
    jQuery("#btnAcidenteTrabalho").click(function () {
        ...
        if (codigoSel != null)
            jQuery(window.document.location).attr('href', 'ManterAcidenteTrabalhoFuncionario.aspx?idUser=' + codigoSel);
        else {
            jQuery.alerts.dialogClass = 'alert-warning';
            jAlert('Selecione um funcionario', 'Alerta', function () {
                jQuery.alerts.dialogClass = null; // reset to default
