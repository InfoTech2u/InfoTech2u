                        ...
                        if (lista[0].Erro != null) {
                            ...
                            if (lista.length > 0) {
                                jQuery('#dyntable').DataTable().row.add([
                                   lista[0].CODIGO_TIPO_FORMA_PAGAMENTO,
                                   lista[0].DESCRICAO,
                                   '<a title="Excluir" href="javascript:Excluir(' + lista[0].CODIGO_TIPO_FORMA_PAGAMENTO + ')" class="deleterow"><i class="icon-trash"></i></a>'
                                ]).draw();
        ...
        jQuery.ajax({
            ...
            if (data['Msg'] != null) {
                ...
                if (tipos.length > 0) {
                    ...
                    for (x in tipos) {
                        jQuery('#dyntable').DataTable().row.add([
                            tipos[x].CodigoTipoFormaPagamento,
                            tipos[x].Descricao,
                            '<a title="Excluir" href="javascript:Excluir(' + tipos[x].CodigoTipoFormaPagamento + ')" class="deleterow"><i class="icon-trash"></i></a>'
                        ]).draw();
                    }
                }
                    }
