<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/InfoTech2u.Master" AutoEventWireup="true" CodeBehind="ManterAlteracaoCargoSalario.aspx.cs" Inherits="InfoTech2u.Verithus.WEB.Modulos.RecursosHumanos.ManterAlteracaoCargoSalario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderInfoTech2u" runat="server">
    <div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li>Dados de Alteração de Cargo e Salario</li>
                    ...
                    <div class="widgetcontent nopadding">
                        <div class="stdform stdform2">
                            ...
                            <p class="stdformbutton">
                                <a href="#"  id="btnConcluirAlteracaoCargoSalario"  class="btn btn-primary btn-rounded">Concluir</a>
