...
namespace InfoTech2u.Verithus.VO
{
    ...
    public partial class TipoAcessoVO
    {
        public TipoAcessoVO()
        {
            this.UsuariosVO = new HashSet<UsuariosVO>();
        }
    
        public int CodigoTipoAcesso { get; set; }
        ...
        public virtual ICollection<UsuariosVO> UsuariosVO { get; set; }
    }
}
