...
namespace InfoTech2u.Verithus.VO
{
    ...
    public partial class DocumentoEstrangeiroVO
    {
        public int CodigoDocumentoEstrangeiro { get; set; }
        public Nullable<int> CodigoFuncionario { get; set; }
        public string NumeroCBO { get; set; }
        public string NumeroCarteira19 { get; set; }
        public string NumeroRegistroGeral { get; set; }
        public string CasadoBrasileiro { get; set; }
        public string Naturalizado { get; set; }
        public string FilhoBrasileiro { get; set; }
        public Nullable<System.DateTime> DataChegadaBrasil { get; set; }
