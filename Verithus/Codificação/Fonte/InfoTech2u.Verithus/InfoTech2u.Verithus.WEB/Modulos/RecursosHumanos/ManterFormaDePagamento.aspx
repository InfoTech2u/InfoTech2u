<%@ Page Title="" Language="C#" MasterPageFile="~/Modulos/InfoTech2u.Master" AutoEventWireup="true" CodeBehind="ManterFormaDePagamento.aspx.cs" Inherits="InfoTech2u.Verithus.WEB.Modulos.RecursosHumanos.ManterFormaDePagamento" %>
       ...
       <ul class="breadcrumbs">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1>Fomulário de Forma de Pagamento</h1>
            </div>
        </div>
        <!--pageheader-->
            ...
            <div class="maincontentinner">
                ...
                <div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade in" id="myModal">
                    <div class="modal-header widgettitle">
                        ...
                        <h4 class="widgettitle">Dados Forma de Pagamento</h4>
                ...
                <h4 class="widgettitle">Formas de Pagamento</h4>
