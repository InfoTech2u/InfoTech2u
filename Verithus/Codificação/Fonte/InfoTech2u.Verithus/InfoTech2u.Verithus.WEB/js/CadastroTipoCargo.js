        ...
        jQuery.ajax({
            ...
            if (data['Msg'] != null) {
                ...
                if (tipos.length > 0) {
                    ...
                    for (x in tipos) {
                        jQuery('#dyntable').DataTable().row.add([
                            tipos[x].CodigoTipoCargo,
                            tipos[x].Descricao,
                            '<a title="Excluir" href="javascript:Excluir(' + tipos[x].CodigoTipoCargo + ')" class="deleterow"><i class="icon-trash"></i></a>'
                        ]).draw();
                    }
                }
                    }
