...
namespace InfoTech2u.Verithus.DA
{
    public class TipoOlhoDA
    {
        public List<TipoOlhoVO> SelecionarTipoOlho(TipoOlhoVO param)
        {
            ...
            List<TipoOlhoVO> listaRetorno = null;
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT053_TIPO_OLHO_PR_SELECIONAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public List<TipoOlhoVO> SelecionarTipoOlhoLista()
        {
