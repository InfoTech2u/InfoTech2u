    ...
    public class FuncionariosDA
    {
        ...
        public DataTable SelecionarFuncionario(FuncionariosVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT027_FUNCIONARIO_PR_SELECIONAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        //SPVRT025_FUNCIONARIO_PR_EXCLUIR
        public DataTable ExcluirFuncionario(FuncionariosVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT025_FUNCIONARIO_PR_EXCLUIR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        //SPVRT026_FUNCIONARIO_PR_INCLUIR
        public DataTable IncluirFuncionario(FuncionariosVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT026_FUNCIONARIO_PR_INCLUIR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
