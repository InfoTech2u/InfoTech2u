    ...
    public class TipoSecaoDA
    {
        public List<TipoSecaoVO> SelecionarSecaoLista(TipoSecaoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT057_TIPO_SECAO_PR_SELECIONAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable IncluirTipoSecao(TipoSecaoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT056_TIPO_SECAO_PR_INCLUIR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable ExcluirTipoSecao(TipoSecaoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT055_TIPO_SECAO_PR_EXCLUIR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
