    ...
    public class SindicatoDA
    {
        public DataTable IncluirSindicato(SindicatoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT031_SINDICATO_PR_INCLUIR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public List<SindicatoVO> SelecionarSindicato(SindicatoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT032_SINDICATO_PR_SELECIONAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
