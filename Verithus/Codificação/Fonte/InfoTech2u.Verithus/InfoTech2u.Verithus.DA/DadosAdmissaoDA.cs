    ...
    public class DadosAdmissaoDA
    {
        public DataTable IncluirAdmissao(DadosAdmissaoVO usuario)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT009_DADOS_ADMISSAO_PR_INCLUIR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable AlterarAdmissao(DadosAdmissaoVO usuario)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT008_DADOS_ADMISSAO_PR_ALTERAR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable SelecionarAdmissao(DadosAdmissaoVO usuario)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT010_DADOS_ADMISSAO_PR_SELECIONAR", lstSqlParameter.ToArray(), null, ref dtRetorno);
