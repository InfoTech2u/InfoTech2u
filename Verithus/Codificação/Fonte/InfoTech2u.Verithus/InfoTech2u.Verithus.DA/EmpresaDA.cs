    ...
    public class EmpresaDA
    {
        public DataTable IncluirEmpresa(EmpresaVO usuario)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT020_EMPRESA_PR_INCLUIR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable AlterarEmpresa(EmpresaVO usuario)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT018_EMPRESA_PR_ALTERAR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable ExcluirEmpresa(EmpresaVO usuario)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT019_EMPRESA_PR_EXCLUIR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable SelecionarEmpresa(EmpresaVO usuario)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT021_EMPRESA_PR_SELECIONAR", lstSqlParameter.ToArray(), null, ref dtRetorno);
