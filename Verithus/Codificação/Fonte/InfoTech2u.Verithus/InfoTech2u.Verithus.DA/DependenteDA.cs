    ...
    public class DependenteDA
    {
        public DataTable SelecionarDependentesDoFuncionario(FuncionariosVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT017_DEPENDENTE_PR_SELECIONAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable IncluirDependente(DependenteVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT016_DEPENDENTE_PR_INCLUIR", lstSqlParameter.ToArray(), transaction, ref dtRetornoDependente);
                ...
                if (dtRetornoDependente != null && dtRetornoDependente.Rows.Count > 0)
                {
                    ...
                    if (param.BeneficioVO.Count > 0)
                    {
                        foreach (var item in param.BeneficioVO)
                        {
                            ...
                            objSql.ExecuteNonQuery("SPVRT002_BENEFICIO_PR_INCLUIR", lstSqlParameter.ToArray(), transaction, out rowsAffected);
        ...
        public DataTable AlterarDependente(DependenteVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT014_DEPENDENTE_PR_ALTERAR", lstSqlParameter.ToArray(), transaction, ref dtRetornoDependente);
