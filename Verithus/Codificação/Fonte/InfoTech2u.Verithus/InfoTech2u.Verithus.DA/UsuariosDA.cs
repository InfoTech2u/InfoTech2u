    ...
    public class UsuariosDA
    {
        ...
        public DataTable VerificarUsuario(UsuariosVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT065_USUARIOS_PR_VERIFICAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public bool ExcluirUsuario(UsuariosVO usuario)
        {
            ...
            try
            {
                ...
                objSql.ExecuteNonQuery("SPVRT062_USUARIOS_PR_EXCLUIR", lstSqlParameter.ToArray(), null, out rowsAffected);
