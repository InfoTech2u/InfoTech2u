    ...
    public class DadosDemissaoDA
    {
        public DataTable IncluirDemissao(DadosDemissaoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT012_DADOS_DEMISSAO_PR_INCLUIR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable AlterarDemissao(DadosDemissaoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT011_DADOS_DEMISSAO_PR_ALTERAR", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable SelecionarDemissao(DadosDemissaoVO usuario)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT013_DADOS_DEMISSAO_PR_SELECIONAR", lstSqlParameter.ToArray(), null, ref dtRetorno);
