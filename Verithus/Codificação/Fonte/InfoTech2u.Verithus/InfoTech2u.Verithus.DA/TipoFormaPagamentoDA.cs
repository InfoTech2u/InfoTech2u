    ...
    public class TipoFormaPagamentoDA
    {
        public List<TipoFormaPagamentoVO> SelecionarFormaPagamentoLista(TipoFormaPagamentoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT050_TIPO_FORMA_PAGAMENTO_PR_SELECIONAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable IncluirTipoFormaPagamento(TipoFormaPagamentoVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("SPVRT049_TIPO_FORMA_PAGAMENTO_PR_INCLUIR", lstSqlParameter.ToArray(), null, ref dtRetorno);
