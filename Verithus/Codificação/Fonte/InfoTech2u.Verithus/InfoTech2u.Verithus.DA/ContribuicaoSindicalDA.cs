...
namespace InfoTech2u.Verithus.DA
{
    ...
    {
        //SPVRT027_FUNCIONARIO_PR_SELECIONAR
        public DataTable SelecionarContribuicaoFuncionario(ContribuicaoSindicalVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT007_CONTRIBUICAO_SINDICAL_PR_SELECIONAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable IncluirContribuicaoSindical(ContribuicaoSindicalVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT006_CONTRIBUICAO_SINDICAL_PR_INCLUIR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public DataTable AlterarContribuicaoSindical(ContribuicaoSindicalVO param)
        {
            ...
            try
            {
                ...
                objSql.Execute("dbo.[SPVRT004_CONTRIBUICAO_SINDICAL_PR_ALTERAR]", lstSqlParameter.ToArray(), null, ref dtRetorno);
        ...
        public bool ExcluirContribuicaoSindical(ContribuicaoSindicalVO param)
        {
            ...
            try
            {
                ...
                objSql.ExecuteNonQuery("dbo.[SPVRT005_CONTRIBUICAO_SINDICAL_PR_EXCLUIR]", lstSqlParameter.ToArray(), null, out rowsAffected);
