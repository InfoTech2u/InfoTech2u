...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('TBVRT045_BENEFICIO') and o.name = 'FK_TBVRT045_REFERENCE_TBVRT012')
alter table TBVRT045_BENEFICIO
   drop constraint FK_TBVRT045_REFERENCE_TBVRT012
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('TBVRT045_BENEFICIO') and o.name = 'FK_TBVRT045_REFERENCE_TBVRT011')
alter table TBVRT045_BENEFICIO
   drop constraint FK_TBVRT045_REFERENCE_TBVRT011
go
...
if exists (select 1
            from  sysobjects
           where  id = object_id('TBVRT044_TIPO_BANCO')
            and   type = 'U')
   drop table TBVRT044_TIPO_BANCO
go

if exists (select 1
            from  sysobjects
           where  id = object_id('TBVRT045_BENEFICIO')
            and   type = 'U')
   drop table TBVRT045_BENEFICIO
go

if exists (select 1
            from  sysobjects
           where  id = object_id('TBVRT045_FUNCIONALIDADE_SISTEMA')
            and   type = 'U')
   drop table TBVRT045_FUNCIONALIDADE_SISTEMA
go

if exists (select 1
            from  sysobjects
           where  id = object_id('TBVRT046_TIPO_FUNCIONALIDADE_SISTEMA')
            and   type = 'U')
   drop table TBVRT046_TIPO_FUNCIONALIDADE_SISTEMA
go

if exists (select 1
            from  sysobjects
           where  id = object_id('TBVRT047_LOG')
            and   type = 'U')
   drop table TBVRT047_LOG
go

if exists (select 1
            from  sysobjects
           where  id = object_id('TBVRT047_SISTEMA')
            and   type = 'U')
   drop table TBVRT047_SISTEMA
go
...
create table TBVRT027_ALTERACAO_CARGO_SALARIO (
   ...
   HORARIO_INICIO       nvarchar(10)                 null,
   HORARIO_FIM          nvarchar(10)                 null,
   CODIGO_USUARIO_CADASTRO int                  null,
   DATA_CADASTRO        datetime             null,
   CODIGO_USUARIO_ALTERACAO int                  null,
   DATA_ALTERACAO       datetime             null,
...
create table TBVRT028_CONTRIBUICAO_SINDICAL (
   ...
   CODIGO_USUARIO_CADASTRO char(10)             null,
   DATA_CADASTRO        datetime             null,
   CODIGO_USUARIO_ALTERACAO int                  null,
   DATA_ALTERACAO       datetime             null,
   CODIGO_STATUS        int                  null,
...
/*==============================================================*/
/* Table: TBVRT044_TIPO_BANCO                                   */
/*==============================================================*/
create table TBVRT044_TIPO_BANCO (
   CODIGO_BANCO         int                  identity,
   NUMERO_BANCO         nvarchar(5)          null,
   ...
   DATA_ALTERACAO       datetime             null,
   CODIGO_STATUS        int                  null,
   constraint PK_TBVRT044_TIPO_BANCO primary key (CODIGO_BANCO)
)
go

/*==============================================================*/
/* Table: TBVRT045_BENEFICIO                                    */
/*==============================================================*/
create table TBVRT045_BENEFICIO (
   CODIGO_BENEFICIO     int                  identity,
   CODIGO_TIPO_BENEFICIO int                  not null,
   CODIGO_DEPENDENTE    int                  null,
   constraint PK_TBVRT045_BENEFICIO primary key (CODIGO_BENEFICIO, CODIGO_TIPO_BENEFICIO)
)
go

/*==============================================================*/
/* Table: TBVRT045_FUNCIONALIDADE_SISTEMA                       */
/*==============================================================*/
create table TBVRT045_FUNCIONALIDADE_SISTEMA (
   CODIGO_FUNCIONALIDADE int                  identity,
   CODIGO_SISTEMA       int                  null,
   DESCRICAO            nvarchar(120)        null,
   CODIGO_USUARIO_CADASTRO int                  null,
   DATA_CADASTRO        datetime             null,
   CODIGO_USUARIO_ALTERACAO int                  null,
   DATA_USUARIO_ALTERACAR datetime             null,
   CODIGO_STATUS        int                  null,
   constraint PK_TBVRT045_FUNCIONALIDADE_SIS primary key (CODIGO_FUNCIONALIDADE)
)
go

/*==============================================================*/
/* Table: TBVRT046_TIPO_FUNCIONALIDADE_SISTEMA                  */
/*==============================================================*/
create table TBVRT046_TIPO_FUNCIONALIDADE_SISTEMA (
   ...
   CODIGO_STATUS        int                  null,
   constraint PK_TBVRT046_TIPO_FUNCIONALIDAD primary key (CODIGO_TIPO_FUNCIONALIDADE)
)
go
...
/* Table: TBVRT047_LOG                                          */
/*==============================================================*/
create table TBVRT047_LOG (
   CODIGO_LOG           int                  identity,
   TIPO_LOG             char(1)              null,
   DESCRICAO            nvarchar(120)        null,
   DATA_GERACAO         datetime             null,
   CODIGO_USUARIO_EXECUCAO int                  null,
   METODO               nvarchar(120)        null,
   constraint PK_TBVRT047_LOG primary key (CODIGO_LOG)
)
go

/*==============================================================*/
/* Table: TBVRT047_SISTEMA                                      */
/*==============================================================*/
create table TBVRT047_SISTEMA (
...
alter table TBVRT045_BENEFICIO
   add constraint FK_TBVRT045_REFERENCE_TBVRT012 foreign key (CODIGO_TIPO_BENEFICIO)
