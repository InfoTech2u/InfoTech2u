...
/****** Object:  StoredProcedure [dbo].[SPVRT018_EMPRESA_PR_ALTERAR]    Script Date: 04/10/2014 13:29:45 ******/
DROP PROCEDURE [dbo].[SPVRT018_EMPRESA_PR_ALTERAR]
GO
...
CREATE PROCEDURE [dbo].[SPVRT018_EMPRESA_PR_ALTERAR]
(
...
BEGIN
	...
	IF(@@ERROR <>0)
		BEGIN
			...
			EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_CADASTRO, 'ALTERAÇÃO DE DADOS DE EMPRESA';
	...
	ELSE
		BEGIN
			...
			EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'A', @DESC , @CODIGO_USUARIO_CADASTRO, 'ALTERAÇÃO DE DADOS DE EMPRESA';
