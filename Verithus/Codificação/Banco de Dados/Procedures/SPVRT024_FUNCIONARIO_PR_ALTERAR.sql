...
/****** Object:  StoredProcedure [dbo].[SPVRT024_FUNCIONARIO_PR_ALTERAR]    Script Date: 19/10/2014 20:59:16 ******/
...
BEGIN
	BEGIN TRY
		...
		--ENDERECO
			...
			IF(@@ERROR = 0)
				...
				EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'A', @DESC , @CODIGO_USUARIO_ALTERACAO, 'ALTERAÇÃO DE FUNCIONÁRIO';
	...
	BEGIN CATCH
		...
		EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_ALTERACAO, 'ALTERAÇÃO DE FUNCIONÁRIO';
