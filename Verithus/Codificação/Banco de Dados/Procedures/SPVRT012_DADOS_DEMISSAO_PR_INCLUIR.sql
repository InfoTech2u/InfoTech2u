...
/****** Object:  StoredProcedure [dbo].[SPVRT012_DADOS_DEMISSAO_PR_INCLUIR]    Script Date: 04/10/2014 05:41:16 ******/
DROP PROCEDURE [dbo].[SPVRT012_DADOS_DEMISSAO_PR_INCLUIR]
GO
...
CREATE PROCEDURE [dbo].[SPVRT012_DADOS_DEMISSAO_PR_INCLUIR]
(
...
BEGIN
	...
	IF(@@ERROR <>0)
		BEGIN
			...
			EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE DADOS DEMISSAO';
	...
	ELSE
		BEGIN
			...
			EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'A', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE DADOS DEMISSAO';
