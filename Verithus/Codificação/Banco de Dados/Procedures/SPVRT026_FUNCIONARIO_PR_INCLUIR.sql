...
/****** Object:  StoredProcedure [dbo].[SPVRT026_FUNCIONARIO_PR_INCLUIR]    Script Date: 28/09/2014 03:40:55 ******/
...
BEGIN
	BEGIN TRY
		BEGIN TRANSACTION
			...
			IF(@@ERROR = 0)
				...
				EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'A', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE FUNCIONÁRIO';
				--Retorna da inclusão
				SELECT
	...
	BEGIN CATCH
		...
		EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_CADASTRO, 'INCLUSÃO DE FUNCIONÁRIO';
