...
/****** Object:  StoredProcedure [dbo].[SPVRT070_ACIDENTE_TRABALHO_PR_INCLUIR]    Script Date: 02/10/2014 16:45:28 ******/
	...
	ELSE
		BEGIN
			...
			SELECT 
				...
				DATA_ALTERACAO,
				CODIGO_STATUS
			FROM TBVRT026_ACIDENTE_TRABALHO
			WHERE CODIGO_ACIDENTE_TRABALHO = @ID
			RETURN
		END
END
