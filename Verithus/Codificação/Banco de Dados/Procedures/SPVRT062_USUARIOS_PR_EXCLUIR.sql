...
/****** Object:  StoredProcedure [dbo].[SPVRT062_USUARIOS_PR_EXCLUIR]    Script Date: 21/09/2014 22:55:56 ******/
DROP PROCEDURE [dbo].[SPVRT062_USUARIOS_PR_EXCLUIR]
GO
...
CREATE PROCEDURE [dbo].[SPVRT062_USUARIOS_PR_EXCLUIR]
(
...
BEGIN
	...
	IF(@@ERROR <>0)
		BEGIN
			...
			EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_ALTERACAO, 'EXCLUSÃO DE USUARIO';
	...
	ELSE
		BEGIN
			...
			EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'A', @DESC , @CODIGO_USUARIO_ALTERACAO, 'EXCLUSÃO DE USUARIO';
			RETURN
		END
		END
END
