		...
		BEGIN
			...
			IF(@@ERROR <>0)
				BEGIN
					...
					EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'E', @DESC , @CODIGO_USUARIO_ALTERACAO, 'ALTERAÇÃO DE DEPENDENTE';
			...
			ELSE
				BEGIN
					...
					EXEC dbo.SPVRT028_LOG_PR_INCLUIR 'A', @DESC , @CODIGO_USUARIO_ALTERACAO, 'ALTERAÇÃO DE DEPENDENTE';
